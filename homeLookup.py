...
with pretrained:
    mname = st.selectbox("Model", options=["homePricing","homePricing_votingmodel","homePricing_nn3layer","homePricing_gradboost_20230220","homePricing_voting_20230220","homePricing_voting_20230221"], index=5)
